...
parser.add_argument('--ngf', dest='ngf', type=int, default=46,
                    help='# of gen filters in first conv layer')
parser.add_argument('--ndf', dest='ndf', type=int, default=46,
...
parser.add_argument('--continue_train', dest='continue_train', type=int, default=0,
                    help='0:false, >0 Continue training (load latest model), start with epoch set to N. <0: Load model and get epoch from it.')
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir',
                    default=os.path.join('.', 'checkpoint'), help='models are saved here')
